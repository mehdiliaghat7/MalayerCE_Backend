    ...
    <section class="section-services section-t8">
        <div class="containerEdit section-header" style=";display: flex;justify-content: center" >
            <div class="col-lg-10" style="text-align: center;width: 100%;">
                ...
                <p style="direction: rtl; text-align: justify">تابلوی اعلانات گروه کامپیوتر. کانال تلگرامی گروه کامپیوتر را
                    به کلیه دانشجویان و اساتید گروه معرفی نمایید
                    تا بتوان در کمترین زماندانشجویان محترم دکترایی که در نیمسال جاری قصد شرکت در آزمون جامع را دارند, لازم
                    است حداکثر تا پایان آبان ماه جاری به کارشناس گروه کامپیوتر موسسه آموزش عالی سلمان، متشکل از اساتید مجرب
                    و نخبه کشور است. از مدت‌ها قبل توجه ویژه به تحصیلات تکمیلی از کامپیوتر موسسه آموزش عالی سلمان، متشکل از
                    اساتید مجرب و نخبه کشور است. از مدت‌ها قبل توجه ویژه به تحصیلات تکمیلی ازکامپیوتر موسسه آموزش عالی
                    سلمان، متشکل از اساتید مجرب و نخبه کشور است. از مدت‌ها قبل توجه ویژه به تحصیلات تکمیلی ازکامپیوتر موسسه
                    آموزش عالی سلمان، متشکل از اساتید مجرب و نخبه کشور است. از مدت‌ها قبل توجه ویژه به تحصیلات تکمیلی
                    ازکامپیوتر موسسه آموزش عالی سلمان، متشکل از اساتید مجرب و نخبه کشور است. از مدت‌ها قبل توجه ویژه به
                    تحصیلات تکمیلی ازکامپیوتر موسسه آموزش عالی سلمان، متشکل از اساتید مجرب و نخبه کشور است. از مدت‌ها قبل
                    توجه ویژه به تحصیلات تکمیلی ازکامپیوتر موسسه آموزش عالی سلمان، متشکل از اساتید مجرب و نخبه کشور است. از
                    مدت‌ها قبل توجه ویژه به تحصیلات تکمیلی ازکامپیوتر موسسه آموزش عالی سلمان، متشکل از اساتید مجرب و نخبه
                    کشور است. از مدت‌ها قبل توجه ویژه به تحصیلات تکمیلی ازکامپیوتر موسسه آموزش عالی سلمان، متشکل از اساتید
                    مجرب و نخبه کشور است. از مدت‌ها قبل توجه ویژه به تحصیلات تکمیلی ازکامپیوتر موسسه آموزش عالی سلمان، متشکل
                    از اساتید مجرب و نخبه کشور است. از مدت‌ها قبل توجه ویژه به تحصیلات تکمیلی ازکامپیوتر موسسه آموزش عالی
                    سلمان، متشکل از اساتید مجرب و نخبه کشور است. از مدت‌ها قبل توجه ویژه به تحصیلات تکمیلی ازکامپیوتر موسسه
                    آموزش عالی سلمان، متشکل از اساتید مجرب و نخبه کشور است. از مدت‌ها قبل توجه ویژه به تحصیلات تکمیلی
                    ازکامپیوتر موسسه آموزش عالی سلمان، متشکل از اساتید مجرب و نخبه کشور است. از مدت‌ها قبل توجه ویژه به
                    تحصیلات تکمیلی ازکامپیوتر موسسه آموزش عالی سلمان، متشکل از اساتید مجرب و نخبه کشور است. از مدت‌ها قبل
                    ...
                    کشور است. از مدت‌ها قبل توجه ویژه به تحصیلات تکمیلی ازکامپیوتر موسسه آموزش عالی سلمان، متشکل از اساتید
                    مجرب و نخبه کشور است. از مدت‌ها قبل توجه ویژه به تحصیلات تکمیلی ازکامپیوتر موسسه آموزش عالی سلمان، متشکل
                    از اساتید مجرب و نخبه کشور است. از مدت‌ها قبل توجه ویژه به تحصیلات تکمیلی از</p>
            </div>
        </div>
    </section>
