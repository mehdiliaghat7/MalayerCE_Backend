        ...
        <div class="animated fadeIn">
                            ...
                            <div class="stat-widget-five">
                                ...
                                <div class="stat-content">
                                    <div class="text-left dib">
                                        ...
                                        <div class="stat-heading">حجم اشتغال شده</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="stat-widget-five">
                                ...
                                <div class="stat-content">
                                    <div class="text-left dib">
                                        ...
                                        <div class="stat-heading">پیام کاربران</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="stat-widget-five">
                                ...
                                <div class="stat-content">
                                    <div class="text-left dib">
                                        ...
                                        <div class="stat-heading">کاربران جدید</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="stat-widget-five">
                                ...
                                <div class="stat-content">
                                    <div class="text-left dib">
                                        ...
                                        <div class="stat-heading">کل کاربران</div>
                                    </div>
                                </div>
            ...
            <div class="orders">
                <div class="row">
                    <div class="col-xl-8">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="box-title" style="text-align: right">کاربران جدید </h4>
                            </div>
                            <div class="card-body--">
                                <div class="table-stats order-table ov-h">
                                    <table class="table ">
                                        ...
                                        <tr>
                                            ...
                                            <td class="avatar">
                                                <div class="round-img">
                                                    <a href="#"><img class="rounded-circle" src="panel/images/avatar/1.jpg"
                                                                     alt=""></a>
                                                </div>
                                            </td>
                                            <td> #5469</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="avatar">
                                                <div class="round-img">
                                                    <a href="#"><img class="rounded-circle" src="panel/images/avatar/2.jpg"
                                                                     alt=""></a>
                                                </div>
                                            </td>
                                            <td> #5468</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="avatar">
                                                <div class="round-img">
                                                    <a href="#"><img class="rounded-circle" src="panel/images/avatar/3.jpg"
                                                                     alt=""></a>
                                                </div>
                                            </td>
                                            <td> #5467</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="avatar">
                                                <div class="round-img">
                                                    <a href="#"><img class="rounded-circle" src="panel/images/avatar/4.jpg"
                                                                     alt=""></a>
                                                </div>
                                            </td>
                                            <td> #5466</td>
                                        ...
                                        <tr class=" pb-0">
                                            ...
                                            <td class="avatar pb-0">
                                                <div class="round-img">
                                                    <a href="#"><img class="rounded-circle" src="panel/images/avatar/6.jpg"
                                                                     alt=""></a>
                                                </div>
                                            </td>
                                            <td> #5465</td>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title box-title" style="text-align: right">لیست اطلاعیه ها</h4>
                                            ...
                                            <div class="msg-received msg-container">
                                                ...
                                                <div class="msg-box">
                                                    <div class="inner-box">
                                                        ...
                                                        <div class="meg" style="text-align: right">سلام استاد وقتتون بخیر خوب هستید؟
