...
<head>
    ...
    <link rel="stylesheet" href="{{asset('panel/assets/css/StyleNew.css')}}">
    <link rel="stylesheet" href="{{asset('panel/assets/css/StyleButton.css')}}">
    <link rel="stylesheet" href="{{asset('panel/assets/css/iransans.css')}}">
...
<script src="{{asset('panel/assets/js/init/fullcalendar-init.js')}}"></script>
